...
import type { createStrategy } from "./ai/tools/create-strategy";
...
import type { listStrategies } from "./ai/tools/list-strategies";
import type { requestSuggestions } from "./ai/tools/request-suggestions";
import type { updateDocument } from "./ai/tools/update-document";
import type { updateStrategy } from "./ai/tools/update-strategy";
...
type listStrategiesTool = InferUITool<ReturnType<typeof listStrategies>>;
type createStrategyTool = InferUITool<ReturnType<typeof createStrategy>>;
type updateStrategyTool = InferUITool<ReturnType<typeof updateStrategy>>;
...
export type ChatTools = {
  ...
  createStrategy: createStrategyTool;
